...
Point Claude at a repository and let Lazarus help make it: running, documented, and audited — behind a guard that **blocks** destructive commands before they ever run.
